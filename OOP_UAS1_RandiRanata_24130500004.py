...
print("--- Scenario Implementation: FC Cakrawala ---")
...
print(f"Added Head Coach: {head_coach.get_full_name()}")
...
print(f"Added Assistant Coach: {assistant_coach.get_full_name()}")
...
for player_data in players_data:
    ...
    print(f"Added Player: {player.get_full_name()} ({player._Player__position}, Jersey: {player._Player__jersey_number})")
...
player_contract = Contract(
    ...
    salary=5000000.0, # IDR
    position="Forward",
    class_name="Player",
    person_id="PPL001"
)
fc_cakrawala_muda._Team__players[0].add_contract(player_contract)
print(f"\nContract created for {fc_cakrawala_muda._Team__players[0].get_full_name()}")